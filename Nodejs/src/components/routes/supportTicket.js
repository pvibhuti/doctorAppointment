...
const { createSupportTicket, getSupportTickets, applyTickets, getApplyTickets, getSelectedApplyTicket, getPatientTicket,
    approveTickets, rejectTickets, uploadMultipleImage, getMessagesByTicket, deleteforEveryOne, editMessage,
    deleteMessages } = require("../supportTickit/model/supportTicketController.js");
...
router.post('/deleteMessages', decryptionProcess, verifyToken, deleteMessages);
