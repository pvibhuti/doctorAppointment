        ...
        <main className="w-full">
                        ...
                        <ul className="flex text-white">
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2">Surat, Katargam</span>
                                </div>
                            </li>
                            <li className="ml-6">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2">+91 9104687247</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="hidden md:block w-full md:w-auto" id="menu">
                        <nav
                            ...
                            <ul className="md:flex items-center">
                                <li className="md:ml-4"><Link to="/register" > <a className="py-2 inline-block md:text-white md:px-2 font-semibold"
                                    href="/register"> Signup </a> </Link></li>
                                <li className="md:ml-6 mt-3 md:mt-0">
                                    <Link to="/login" > <a className="inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded"
                                        href="/login" >Log in </a> </Link>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <section
                ...
                <div className="md:flex md:items-center md:justify-center">
                    ...
                    {/* <a className="px-8 py-4 bg-white text-blue-600 rounded inline-block font-semibold md:ml-8 mt-4 md:mt-0" href="../src/components/common/login.jsx" > <Link to="/bookApointment" >Book Appointment</Link></a> */}
                </div>
            </section>
            {/* <!-- end cta --> */}
      ...
      items-center min-h-screen">
                    ...
                    <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
                        <div>
                            <h1 className="text-white text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">A better life starts with a
                                healthy
                                Life.</h1>
                            <p className="text-blue-100 text-xl md:text-2xl leading-snug mt-4">Welcome to the our Hospital.</p>
                            <a href="/" className="px-8 py-4 bg-teal-500 text-white rounded inline-block mt-8 font-semibold"> <Link to="/login" >Book
                                Appointment </Link></a>
                        </div>
                    </div>
                </section>
            ...
            <section className="relative px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-32">
                <div className="flex flex-col lg:flex-row lg:-mx-8">
                    <div className="w-full lg:w-1/2 lg:px-8">
                        <h2 className="text-3xl leading-tight font-bold mt-4">Welcome to the Our Hospital</h2>
                ...
                <div className="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
                    ...
                    <div className="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
                        <div className="bg-white rounded-lg border border-gray-300 p-8">
                            <h4 className="text-xl font-bold mt-4">Surgery</h4>
                            <p className="mt-1">Let us show you how our experience.</p>
                            <a href="/" className="block mt-4">Read More</a>
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
                        <div className="bg-white rounded-lg border border-gray-300 p-8">
                            <h4 className="text-xl font-bold mt-4">Psychiatry</h4>
                            <p className="mt-1">Let us show you how our experience.</p>
                            <a href="/" className="block mt-4">Read More</a>
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
                        <div className="bg-white rounded-lg border border-gray-300 p-8">
                            <h4 className="text-xl font-bold mt-4">Diagnostic imaging</h4>
                            <p className="mt-1">Let us show you how our experience.</p>
                            <a href="/" className="block mt-4">Read More</a>
                        </div>
                    </div>
            ...
            <section className="relative bg-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-32">
                <div className="">
                    ...
                    <p className="text-gray-600 mt-2 md:max-w-lg">Pellentesque habitant morbi tristique senectus et netus et malesuada
                        fames ac
                        turpis egestas.</p>
            ...
            {/* <section
                className="relative bg-blue-teal-gradient px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 text-center md:text-left">
                <div className="md:flex md:items-center md:justify-center">
                    <h2 className="text-xl font-bold text-white">Get in touch with us today! Call us on: +1
                        562-789-1935</h2>
                    <a href="/" className="px-8 py-4 bg-white text-blue-600 rounded inline-block font-semibold md:ml-8 mt-4 md:mt-0">Book
                        Appointment</a>
                </div>
            </section> */}
            {/* <!-- end cta --> */}
            ...
            <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
                <div className="flex flex-col md:flex-row">
                    <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                        <h3 className="font-bold text-2xl">Hospital Managment</h3>
                    ...
                    <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                        ...
                        <ul className="mt-4">
                            <li className="mt-2"><a href="/" title="" className="opacity-75 hover:opacity-100">Surgery</a></li>
                            <li className="mt-2"><a href="/" title="" className="opacity-75 hover:opacity-100">Diagnostic imaging</a></li>
                            <li className="mt-2"><a href="/" title="" className="opacity-75 hover:opacity-100">Psychiatry</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                        ...
                        <p className="text-sm text-gray-400 mt-12">© 2018 ProDentists. Rights Reserved.
                        </p>
                    </div>
                </div>
            </footer>
